...
const features = [
  { icon: "📱", title: "Plan personalizado", desc: "Rutinas diseñadas por David adaptadas a tus objetivos, nivel y disponibilidad. Actualizadas cada mes." },
  { icon: "📹", title: "Videollamadas semanales", desc: "Sesiones por videollamada para revisar técnica, resolver dudas y ajustar tu plan." },
  { icon: "⚖", title: "Control de pesajes", desc: "Registro semanal de peso, % grasa y % músculo con gráficas de evolución en la app." },
  { icon: "🍎", title: "Pautas de nutrición", desc: "Guía nutricional adaptada a tu objetivo. Sin dietas genéricas, ajustada a tu vida real." },
  { icon: "💬", title: "Chat directo", desc: "Contacto directo por WhatsApp para dudas rápidas, ajustes de entreno o motivación." },
  { icon: "📊", title: "Informes mensuales", desc: "Cada mes recibes un resumen de tu progreso con datos, gráficas y próximos pasos." },
];
...
export default function EntrenosOnline() {
  ...
  return (
    <div className="eo-page">
      ...
      <section className="eo-hero">
        ...
        <div className="container eo-hero__content">
          ...
          <motion.h1 className="eo-hero__title" variants={fadeUp} initial="hidden" animate="visible" custom={1}>
            <span className="eo-hero__title--shadow">METODO</span>
            <br />
            <span className="eo-hero__title--accent">EL DETALLE</span>
          </motion.h1>
          ...
          <motion.div className="eo-hero__ctas" variants={fadeUp} initial="hidden" animate="visible" custom={3}>
            ...
            <a href="#contacto-entrenos" className="btn-ghost">Contactar</a>
          </motion.div>
        </div>
      ...
      {/* ══ VIDEO INTRODUCCIÓN ══ */}
      <section className="eo-section eo-section--intro">
        <div className="container">
          <motion.div className="eo-section-header" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <p className="eo-label">Conoce el metodo</p>
            <h2 className="eo-section__title">Asi entrenamos</h2>
            <div className="eo-cyan-line" />
          </motion.div>

          <motion.div className="eo-intro-video"
          ...
          {/* Contacto Dabuky */}
          <motion.div className="eo-intro-contact" id="contacto-entrenos"
            variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={2}>
            <div className="eo-intro-contact__info">
              <p className="eo-intro-contact__label">Mas informacion</p>
              <h3 className="eo-intro-contact__name">Dabuky</h3>
              <p className="eo-intro-contact__role">Entrenador personal · Metodo One Life</p>
            </div>
            <a href="https://wa.me/34601387263?text=Hola%20Dabuky!%20Quiero%20info%20sobre%20el%20Método%20One%20Life"
              target="_blank" rel="noreferrer" className="eo-intro-contact__btn">
        ...
        <div className="container">
          ...
          <motion.div className="eo-discount" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={1}>
            ...
            <div className="eo-discount__code-wrap">
              ...
              <button className="eo-discount__copy"
                onClick={() => {
          ...
          <div className="eo-products">
            {products.map((p, i) => (
              <motion.div key={p.name} className="eo-product"
                ...
                <a href={p.url} target="_blank" rel="noreferrer" className="eo-product__btn">Comprar</a>
              </motion.div>
            ))}
          </div>
        ...
        <div className="container eo-cta__inner">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <div className="eo-cta__buttons">
              <a href="https://www.instagram.com/one.life.one.body.benidorm/" target="_blank" rel="noreferrer" className="btn-ghost">Instagram</a>
